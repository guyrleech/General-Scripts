function Start-DigitalClock {
    ...
    .NOTES
        ...
        @stevenjudd 2020-05-15  Convert to function and update name of inline function. Renamed to Start-DigitalClock-Function.ps1 and updated Examples.
    #>
...
'@
    ...
    if ( ! ( $Form = LoadGUI -inputXaml $mainwindowXAML ) ) {
        Exit 1
    }
    ...
    $WPFbtnMark.Add_Click( {
            ...
            if ( $markerTextForm = LoadGUI -inputXaml $markerTextXAML ) {
...
} #end Start-DigitalClock function